                ...
                <children>
                    <div className="w-[95%] mx-auto mt-7">
                        <div className='flex justify-between items-center w-full'>
                            <div>
                                <h1 className='text-[60px] md:text-[50px] font-bold'>Update Info</h1>
                            </div>
                        </div>
                        {/* Form Started Here */}
                        <div className='w-full'>
                            <form action="">
                                ...
                                <div className='flex justify-start items-center gap-3 my-10'>
                                    <Link className='text-[16px] bg-black px-4 py-2 text-white rounded-[10px] font-semibold dark:bg-[#121212]'>Update</Link>
