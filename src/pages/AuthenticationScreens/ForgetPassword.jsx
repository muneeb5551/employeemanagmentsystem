                    ...
                    <div className="w-[100%]">
                        <div className={`${styles.maincontainer} w-[100%] md:w-[70%] mx-auto flex justify-between flex-col md:flex-row items-center gap-5 bg-black md:bg-white`}>
                            <div className="w-[100%]  md:w-[45%] flex justify-center items-center">
                                ...
                                {/* Mobile View SignIn */}
                                <h1 className={`${styles.MobileViewMainHeading} block md:hidden text-white`}>Forget Password</h1>
                                {/* Mobile View SignIn */}
                            </div>
                            <div className={`${styles.MobileViewloginForm} w-[100%] md:w-[50%] bg-white`}>
                                <h1 className={`${styles.login_main_signin_Heading} hidden md:block`}>Forget Password</h1>
                                <h1 className={styles.login_main_text_Heading}>Enter your email to reset your password</h1>
