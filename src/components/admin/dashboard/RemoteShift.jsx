...
const RemoteShift = () => {
    ...
    return (
        <div>
            ...
            <div
                className="w-[15.2%] bg-[#fdf7e5] rounded-[4px] border-[#FFAE00] border-1 h-[55px]"
                onClick={handleClick}
            >
                <p className='text-[#FFAE00] pl-[7px] pt-[5px] font-bold text-[14px] cursor-pointer font-dm-sans'>Remote</p>
            </div>
                ...
                <div className="fixed dark:bg-[#222222] top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white w-[340px] h-[174px] z-20 border-0 rounded-[25px] p-4 shadow-lg">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-[10px]">
                            ...
                            <p className='font-bold font-dm-sans text-[16px]'>Remote</p>
                        </div>
